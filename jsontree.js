  ...
  var _render = function(obj, p, options){
    ...
    for (var key in obj) {
      ...
      if (obj[key] === null){
        ...
        parent.append('<li><span class="key">'+key+':</span><span path="' + key + '" class="value boolean">'+$("<div>").text(obj[key]).html()+'</span>'+coma+'</li>');
      } else if (typeof obj[key] === 'number'){
        parent.append('<li><span class="key">'+key+':</span><span path="' + key + '" class="value number">'+$("<div>").text(obj[key]).html()+'</span>'+coma+'</li>');
      } else if (typeof obj[key] === 'string'){
        parent.append('<li><span class="key">'+key+':</span><span path="' + key + '" class="value string">"'+$("<div>").text(obj[key]).html()+'"</span>'+coma+'</li>');
